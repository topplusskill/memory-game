...
const MultiplayerGame: React.FC<MultiplayerGameProps> = ({
  ...
  // Verificar se é uma nova partida (nível 1) ou se a sequência aumentou
  if ((currentLength > 0 && currentLength !== lastSequenceLength) || 
      (currentLength === 1 && lastSequenceLength === 0)) {
...
}, [gameState.gameSequence, lastSequenceLength, isShowingSequence, soundEnabled, playBeep]);
